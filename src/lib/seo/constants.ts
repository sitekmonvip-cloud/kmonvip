...
export const services: Service[] = [
  {
    ...
    features: [
      { title: "Frota premium renovada", desc: "Sedans Mercedes-Benz Classe E, SUVs Cadillac Escalade e equivalentes." },
    ...
    faqs: [
      {
        ...
        a: "Sedans executivos (Mercedes-Benz Classe E ou similar) e SUVs premium (Cadillac Escalade ou similar). Para agendas que exigem segurança elevada, há opção de veículos blindados nível B6.",
      },
      {
...
export const fleet: FleetCategory[] = [
  {
    ...
    hook: "Sedan Executivo com Motorista — Mercedes-Benz Classe E ou Similar",
    meta: {
      title: "Sedan Executivo com Motorista — Locação",
      description: "Sedan executivo Mercedes-Benz Classe E ou similar com motorista, para 1 a 4 passageiros. Mobilidade premium para executivos e agendas individuais.",
      keywords: [
        "sedan executivo com motorista",
        "Mercedes Classe E executivo",
        ...
        "sedan corporativo",
        "Audi A6 executivo",
        "BMW Série 5 executivo",
      ],
    },
    intro: "Sedans executivos com motorista para deslocamentos corporativos, reuniões, recepções de clientes e agendas individuais. Frota Mercedes-Benz Classe E ou similar, com acabamento premium, ar-condicionado dual zone, motorista uniformizado e atendimento bilíngue.",
    specs: { passengers: "1 a 4 passageiros", model: "Mercedes-Benz Classe E ou similar" },
    features: ["Acabamento premium", "Ar-condicionado dual zone", "Wi-Fi disponível", "Motorista uniformizado", "Atendimento bilíngue"],
    image: "/images/fleet/sedan-executivo.webp",
  },
  {
    slug: "suv-premium",
    name: "SUV Premium",
    hook: "SUV Premium com Motorista — Cadillac Escalade ou Similar",
    meta: {
      title: "SUV Premium com Motorista — Locação",
      description: "SUV de luxo Cadillac Escalade ou similar com motorista, para 1 a 6 passageiros. Conforto e espaço para executivos e autoridades.",
      keywords: [
        "SUV executivo com motorista",
        "Cadillac Escalade locação",
        "SUV premium Brasília",
        "SUV de luxo com motorista",
        "Range Rover executivo",
        "SUV VIP",
        "SUV corporativo",
        "Chevrolet Suburban executivo",
        "SUV executivo São Paulo",
        "locação SUV premium",
      ],
    },
    intro: "SUVs de luxo com motorista para executivos, autoridades e deslocamentos que exigem maior conforto, espaço e presença. Frota Cadillac Escalade ou similar, atendimento bilíngue e padrão executivo.",
    specs: { passengers: "1 a 6 passageiros", model: "Cadillac Escalade ou similar" },
    features: ["Espaço para 6 passageiros", "Bagagem ampla", "Acabamento de luxo", "Som premium", "Vidros privativos"],
    image: "/images/fleet/suv-executivo.webp",
  },
  {
    slug: "veiculo-blindado",
    name: "Veículo Blindado",
    hook: "Veículo Blindado B6 com Motorista — Segurança Executiva",
    meta: {
      title: "Veículo Blindado com Motorista — Locação B6",
      description: "Veículo blindado nível B6 com motorista treinado em direção defensiva. Para 1 a 4 passageiros. Segurança elevada para executivos, autoridades e diplomatas.",
      keywords: [
        "veículo blindado com motorista",
        "carro blindado B6",
        "SUV blindado executivo",
        "Jeep Commander blindado",
        "locação veículo blindado",
        "blindado para diplomatas",
    ...
    intro: "Veículos blindados nível B6 com motorista treinado em direção defensiva e evasiva. Frota renovada, padrão internacional de proteção, para agendas que exigem segurança elevada, confidencialidade e atuação em zonas de risco.",
  ...
  {
    slug: "frota-comitiva",
    name: "Frota para Comitiva",
    hook: "Frota Coordenada para Comitivas — SUV, Sedan e Van",
    meta: {
      title: "Frota para Comitivas — Operação Coordenada KMON VIP",
      description: "Combinação coordenada de SUVs, sedans e vans com motoristas para comitivas, delegações e visitas oficiais. Operação sob coordenação única.",
      keywords: [
        "frota para comitiva",
        "transporte para delegação coordenada",
        "frota coordenada executivos",
        "transporte para visita oficial",
        "frota para missão diplomática",
        "comitiva presidencial transporte",
        "transporte VIP coordenado",
        "logística de transporte comitiva",
        "frota com escolta",
        "transporte para chefes de Estado",
      ],
    },
    intro: "Para comitivas, delegações e missões oficiais, combinamos SUVs, sedans e vans em operação coordenada sob comando único. Frota dimensionada conforme o protocolo da missão, com motoristas treinados, opção de escolta e suporte 24 horas durante toda a agenda.",
    specs: { passengers: "Sob medida", model: "SUV + Sedan + Van coordenados" },
    features: ["Frota coordenada", "Comando único de operação", "Suporte 24h dedicado", "Opção de escolta", "Atendimento bilíngue"],
...
export const crossPages: CrossPage[] = [
  // Transporte Executivo + 3 cidades
  {
    ...
    faqs: [
      { q: "Qual a frota disponível em Brasília?", a: "Sedans Mercedes-Benz Classe E, SUVs Cadillac Escalade e equivalentes premium. Frota blindada B6 também disponível na cidade." },
